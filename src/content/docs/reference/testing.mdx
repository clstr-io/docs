---
title: Testing
description: API reference for attest, the testing framework used to write black-box tests for clstr challenges.
---

`attest` is the testing framework behind clstr challenges. It provides a fluent API for writing black-box tests against programs running in Docker containers, validating external behavior without accessing implementation internals. The source is at [`internal/attest`](https://github.com/clstr-io/clstr/tree/main/internal/attest).
