...
Your implementation doesn't need to do anything special. Impairments are applied at the network level, so RPCs will be slower or occasionally fail, but no application-level changes are required.
